...
import type { createBall as golf__createBall } from "../golf";
import type { createLevel as golf__createLevel } from "../golf";
import type { getBall as golf__getBall } from "../golf";
import type { getBalls as golf__getBalls } from "../golf";
import type { getLevel as golf__getLevel } from "../golf";
import type { publishStroke as golf__publishStroke } from "../golf";
...
export type ConvexAPI = {
  queries: {
    "golf:getBall": ClientQuery<typeof golf__getBall>;
    "golf:getBalls": ClientQuery<typeof golf__getBalls>;
    "golf:getLevel": ClientQuery<typeof golf__getLevel>;
  };
  mutations: {
    "golf:createBall": ClientMutation<typeof golf__createBall>;
    "golf:createLevel": ClientMutation<typeof golf__createLevel>;
    "golf:publishStroke": ClientMutation<typeof golf__publishStroke>;
  };
};
